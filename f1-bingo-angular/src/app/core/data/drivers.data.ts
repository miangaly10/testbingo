...
export const F1_DRIVERS: F1Driver[] = [
  ...
  { num: '12', code: 'ANT', first: 'Kimi',      last: 'Antonelli',  team: 'MER', color: '#27F4D2', img: `${BASE}/A/ANDANT01_Andrea_Kimi_Antonelli/andant01.png` },
  ...
  { num: '41', code: 'LIN', first: 'Arvid',     last: 'Lindblad',   team: 'RB',  color: '#6692FF', img: `${BASE}/A/ARVLIN01_Arvid_Lindblad/arvlin01.png` },
